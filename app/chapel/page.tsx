...
export default function ChapelPage() {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-3xl bg-black/55 border border-white/10 rounded-xl p-6 md:p-10 shadow-2xl backdrop-blur-sm fade-in-soft">
        ...
        <section className="mt-8 space-y-4 text-sm md:text-base text-white/85 leading-relaxed">
          ...
          <p>
            The Chapel belongs to the <span className="text-fevernaGold">Relics</span> of the hotel—small texts,
            symbols, and quiet artifacts meant to set the tone, not fill a playlist.
          </p>
