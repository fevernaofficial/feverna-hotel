...
export default function CourtyardPage() {
  return (
    <main
      ...
      style={{
        backgroundImage: "url('/images/courtyard.webp')",
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none bg-linear-to-b from-black/10 via-transparent to-black/25" />
      ...
      <div className="relative z-10 w-full max-w-4xl bg-black/55 border border-white/10 rounded-xl p-6 md:p-10 shadow-2xl backdrop-blur-sm fade-in-soft flex flex-col max-h-[calc(100dvh-9rem)]">
        <header className="text-center">
          ...
          <p className="mt-4 text-sm md:text-base text-white/80">
            Open air inside the hotel’s walls. A place for ambient pieces that
            behave like weather.
          </p>
        </header>
          ...
          <section className="space-y-6 text-sm md:text-base text-white/85 leading-relaxed">
            <div>
              ...
              <p className="mt-2 text-white/80">
                The Courtyard belongs to the{" "}
                <span className="text-fevernaGold">Ground Floor</span>— rooms for
                installations, interludes, and one-off works. This wing is for
                pieces that loop well, breathe slowly, and feel like presence
            ...
            <ul className="list-disc pl-5 space-y-2 text-white/80">
              ...
              <li>
                If a track belongs upstairs, it will go upstairs. This room
                doesn’t compete with canon.
              </li>
            </ul>

            <p className="text-xs md:text-sm text-white/60">
              Over time, the Courtyard will collect ambient installations:
              rainfall, wind, distance, slow light.
            </p>
