...
export default function RoomPlayer({
  ...
  // New controls:
  showHeader = true,
  showRoomContents = true,
  showAutoRotateToggle = true,
}: {
  videos: RoomVideo[];
  defaultId?: string;
  ...
  }, [autoRotate, enableAutoRotate, videos.length, videos]);
    ...
    <div className="space-y-4">
      {showHeader ? (
        <div className="flex items-center justify-between gap-3">
          ...
          {enableAutoRotate && showAutoRotateToggle ? (
            <button
              type="button"
      ...
      <YouTubeEmbed id={active.id} title={active.title} autoPlay />
