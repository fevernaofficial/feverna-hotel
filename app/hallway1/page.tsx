...
import { getCanonRoomsForHallway } from "../lib/rooms";
...
export default function Hallway1Page() {
  const openRooms = getCanonRoomsForHallway(ROUTES.hallway1);
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-1 text-xs md:text-sm text-white/60">
                    {room.roomNote ?? "A door prepared in time."}
                  </div>
                </Link>
              );
            })}
